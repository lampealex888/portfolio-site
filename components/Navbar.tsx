    ...
    <div className="bg-base-200">
      <div className="navbar m-auto max-w-7xl flex-col gap-2 sm:flex-row">
        <div className="flex-1">
          <Link href="/" className="btn btn-ghost link link-primary no-underline text-xl normal-case">
            <svg
              fill="currentColor"
              width="24px"
              height="24px"
        ...
        <div className="flex-none">
          <Link
            ...
            className="btn btn-ghost text-lg normal-case link link-primary no-underline "
          >
            Resume
          </Link>
          <Link
            ...
            rel="noopener noreferrer"
            className="btn btn-circle btn-ghost link link-primary "
          >
