...
const Header = () => {
  return (
    <div id="header" className="bg-base-200 px-4 min-w-[300px]">
      <div className="navbar m-auto max-w-7xl flex-col gap-2 sm:flex-row">
        ...
        <div className="flex-none">
          <a
            ...
            className="btn btn-ghost link-primary text-lg normal-case"
          >
            <p>Resume</p>
          </a>
          <a
            href="https://github.com/lampealex888"
            className="btn btn-circle btn-ghost link-primary"
          >
          ...
          <a href="/rss" className="btn btn-circle btn-ghost link-primary">
            <svg
              className="fill-current w-[24px] h-[24px]"
              viewBox="0 0 448 512"
            >
